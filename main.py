...
CAT_DICT = {
    # === МЯУКАНИЕ (Meowing) ===
    # Frequency: 300-6000 Hz, main: 1000-4000 Hz
    # High pitch = strong emotion (hunger, distress)
    'мяу': '🐱 МЯУКАНИЕ\n━━━━━━━━━━━━━━━━\nЧастота: 1-4 кГц\nЗначение: Приветствие или просьба\nКонтекст: Проверь — голод или внимание?\n\n🔬 Научное: Коты "разговаривают" с людьми, а не между собой!',
    ...
    # === МУРЛЫКАНЬЕ (Purring) ===
    # Frequency: 25-150 Hz (низкая!)
    # Can mean contentment OR stress/self-healing
    'мур': '🐱 МУРЛЫКАНЬЕ\n━━━━━━━━━━━━━━━━\nЧастота: 25-150 Гц\nЗначение: Удовольствие или стресс\nКонтекст: Смотри на тело кота!\n\n🔬 Научное: 25 Гц — частота вибрации костей/заживления. Кот может лечить себя или быть в стрессе.',
...
def cat_translate(text):
    ...
    if found:
        ...
        result += '\n\n📚 Источники: Animal Behaviour, акустический анализ 300-10000 Hz'
        return result
